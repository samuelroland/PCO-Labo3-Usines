...
EmployeeType getEmployeeThatProduces(ItemType item) {
    switch (item) {
        ...
        case ItemType::Petrol:
            return EmployeeType::Extractor;
        case ItemType::Chip:
            return EmployeeType::Electrician;
        case ItemType::Plastic:
            return EmployeeType::Plasturgist;
        case ItemType::Robot:
            return EmployeeType::Engineer;
        default:
            return EmployeeType::Extractor;// Why not
    }
}

int getEmployeeSalary(EmployeeType employee) {
    switch (employee) {
        case EmployeeType::Extractor:
            return EXTRACOTR_COST;
        case EmployeeType::Electrician:
            return ELECTRICIAN_COST;
        case EmployeeType::Engineer:
            return ENGINEER_COST;
        case EmployeeType::Plasturgist:
            return PLASTIC_COST;
        default:
            return 0;
    }
